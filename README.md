...
New install? Start here: [Getting started](https://docs.openx.bot/start/getting-started)

**Subscriptions (OAuth):**
- **[Anthropic](https://www.anthropic.com/)** (Claude Pro/Max)
- **[OpenAI](https://openai.com/)** (ChatGPT/Codex)

Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.openx.bot/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.openx.bot/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.openx.bot/concepts/model-failover)
...
# Send a message
openx message send --to +1234567890 --message "Hello from openx"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
openx agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.openx.bot/install/updating) (and run `openx doctor`).
...
Switch channels (git + npm): `openx update --channel stable|beta|dev`.
Details: [Development channels](https://docs.openx.bot/install/development-channels).
...
pnpm openx onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm openx ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `openx` binary.

## Security defaults (DM access)

openx connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.openx.bot/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:
- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `openx pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `openx doctor` to surface risky/misconfigured DM policies.
...
[![Star History Chart](https://api.star-history.com/svg?repos=openx/openx&type=date&legend=top-left)](https://www.star-history.com/#openx/openx&type=date&legend=top-left)

## Everything we built so far

### Core platform
- [Gateway WS control plane](https://docs.openx.bot/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.openx.bot/web), and [Canvas host](https://docs.openx.bot/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.openx.bot/tools/agent-send): gateway, agent, send, [wizard](https://docs.openx.bot/start/wizard), and [doctor](https://docs.openx.bot/gateway/doctor).
- [Pi agent runtime](https://docs.openx.bot/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.openx.bot/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.openx.bot/concepts/groups).
- [Media pipeline](https://docs.openx.bot/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.openx.bot/nodes/audio).

### Channels
- [Channels](https://docs.openx.bot/channels): [WhatsApp](https://docs.openx.bot/channels/whatsapp) (Baileys), [Telegram](https://docs.openx.bot/channels/telegram) (grammY), [Slack](https://docs.openx.bot/channels/slack) (Bolt), [Discord](https://docs.openx.bot/channels/discord) (discord.js), [Google Chat](https://docs.openx.bot/channels/googlechat) (Chat API), [Signal](https://docs.openx.bot/channels/signal) (signal-cli), [iMessage](https://docs.openx.bot/channels/imessage) (imsg), [BlueBubbles](https://docs.openx.bot/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.openx.bot/channels/msteams) (extension), [Matrix](https://docs.openx.bot/channels/matrix) (extension), [Zalo](https://docs.openx.bot/channels/zalo) (extension), [Zalo Personal](https://docs.openx.bot/channels/zalouser) (extension), [WebChat](https://docs.openx.bot/web/webchat).
- [Group routing](https://docs.openx.bot/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.openx.bot/channels).

### Apps + nodes
- [macOS app](https://docs.openx.bot/platforms/macos): menu bar control plane, [Voice Wake](https://docs.openx.bot/nodes/voicewake)/PTT, [Talk Mode](https://docs.openx.bot/nodes/talk) overlay, [WebChat](https://docs.openx.bot/web/webchat), debug tools, [remote gateway](https://docs.openx.bot/gateway/remote) control.
- [iOS node](https://docs.openx.bot/platforms/ios): [Canvas](https://docs.openx.bot/platforms/mac/canvas), [Voice Wake](https://docs.openx.bot/nodes/voicewake), [Talk Mode](https://docs.openx.bot/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.openx.bot/platforms/android): [Canvas](https://docs.openx.bot/platforms/mac/canvas), [Talk Mode](https://docs.openx.bot/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.openx.bot/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation
- [Browser control](https://docs.openx.bot/tools/browser): dedicated openx Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.openx.bot/platforms/mac/canvas): [A2UI](https://docs.openx.bot/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.openx.bot/nodes): camera snap/clip, screen record, [location.get](https://docs.openx.bot/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.openx.bot/automation/cron-jobs); [webhooks](https://docs.openx.bot/automation/webhook); [Gmail Pub/Sub](https://docs.openx.bot/automation/gmail-pubsub).
- [Skills platform](https://docs.openx.bot/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety
- [Channel routing](https://docs.openx.bot/concepts/channel-routing), [retry policy](https://docs.openx.bot/concepts/retry), and [streaming/chunking](https://docs.openx.bot/concepts/streaming).
- [Presence](https://docs.openx.bot/concepts/presence), [typing indicators](https://docs.openx.bot/concepts/typing-indicators), and [usage tracking](https://docs.openx.bot/concepts/usage-tracking).
- [Models](https://docs.openx.bot/concepts/models), [model failover](https://docs.openx.bot/concepts/model-failover), and [session pruning](https://docs.openx.bot/concepts/session-pruning).
- [Security](https://docs.openx.bot/gateway/security) and [troubleshooting](https://docs.openx.bot/channels/troubleshooting).

### Ops + packaging
- [Control UI](https://docs.openx.bot/web) + [WebChat](https://docs.openx.bot/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.openx.bot/gateway/tailscale) or [SSH tunnels](https://docs.openx.bot/gateway/remote) with token/password auth.
- [Nix mode](https://docs.openx.bot/install/nix) for declarative config; [Docker](https://docs.openx.bot/install/docker)-based installs.
- [Doctor](https://docs.openx.bot/gateway/doctor) migrations, [logging](https://docs.openx.bot/logging).
...
openx can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
Notes:
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (openx enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.openx.bot/gateway/tailscale) · [Web surfaces](https://docs.openx.bot/web)
...
Details: [Remote access](https://docs.openx.bot/gateway/remote) · [Nodes](https://docs.openx.bot/nodes) · [Security](https://docs.openx.bot/gateway/security)
...
Details: [Nodes](https://docs.openx.bot/nodes) · [macOS app](https://docs.openx.bot/platforms/macos) · [Gateway protocol](https://docs.openx.bot/concepts/architecture)
...
- Controlled via `openx nodes …`.

Runbook: [iOS connect](https://docs.openx.bot/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.openx.bot/platforms/android).
...
Minimal `~/.clawdbot/openx.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.openx.bot/gateway/configuration)
...
Details: [Security guide](https://docs.openx.bot/gateway/security) · [Docker + sandboxing](https://docs.openx.bot/install/docker) · [Sandbox config](https://docs.openx.bot/gateway/configuration)

### [WhatsApp](https://docs.openx.bot/channels/whatsapp)

- Link the device: `pnpm openx channels login` (stores creds in `~/.clawdbot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.openx.bot/channels/telegram)
...
### [Slack](https://docs.openx.bot/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.openx.bot/channels/discord)
...
### [Signal](https://docs.openx.bot/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.openx.bot/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.openx.bot/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.openx.bot/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.openx.bot)
- [Read the architecture overview for the gateway + protocol model.](https://docs.openx.bot/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.openx.bot/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.openx.bot/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.openx.bot/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.openx.bot/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.openx.bot/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.openx.bot/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.openx.bot/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.openx.bot/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.openx.bot/platforms/windows), [Linux](https://docs.openx.bot/platforms/linux), [macOS](https://docs.openx.bot/platforms/macos), [iOS](https://docs.openx.bot/platforms/ios), [Android](https://docs.openx.bot/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.openx.bot/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.openx.bot/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.openx.bot/gateway/discovery)
- [Bonjour/mDNS](https://docs.openx.bot/gateway/bonjour)
- [Gateway pairing](https://docs.openx.bot/gateway/pairing)
- [Remote gateway README](https://docs.openx.bot/gateway/remote-gateway-readme)
- [Control UI](https://docs.openx.bot/web/control-ui)
- [Dashboard](https://docs.openx.bot/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.openx.bot/gateway/health)
- [Gateway lock](https://docs.openx.bot/gateway/gateway-lock)
- [Background process](https://docs.openx.bot/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.openx.bot/tools/browser-linux-troubleshooting)
- [Logging](https://docs.openx.bot/logging)

## Deep dives

- [Agent loop](https://docs.openx.bot/concepts/agent-loop)
- [Presence](https://docs.openx.bot/concepts/presence)
- [TypeBox schemas](https://docs.openx.bot/concepts/typebox)
- [RPC adapters](https://docs.openx.bot/reference/rpc)
- [Queue](https://docs.openx.bot/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.openx.bot/tools/skills-config)
- [Default AGENTS](https://docs.openx.bot/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.openx.bot/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.openx.bot/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.openx.bot/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.openx.bot/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.openx.bot/reference/templates/TOOLS)
- [Templates: USER](https://docs.openx.bot/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.openx.bot/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.openx.bot/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.openx.bot/platforms/mac/voicewake)
- [iOS node](https://docs.openx.bot/platforms/ios)
- [Android node](https://docs.openx.bot/platforms/android)
- [Windows (WSL2)](https://docs.openx.bot/platforms/windows)
- [Linux app](https://docs.openx.bot/platforms/linux)

## Email hooks (Gmail)

- [docs.openx.bot/gmail-pubsub](https://docs.openx.bot/automation/gmail-pubsub)

## openxy

openx was built for **openxy**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [clawd.me](https://clawd.me)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@openx](https://x.com/openx)
