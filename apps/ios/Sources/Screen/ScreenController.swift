...
final class ScreenController {
    ...
    /// Callback invoked when a openx:// deep link is tapped in the canvas
    ...
    func snapshotBase64(
        ...
        format: openxCanvasSnapshotFormat,
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = openxKitResources.bundle
...
/// Handles navigation policy to intercept openx:// deep links from canvas
@MainActor
