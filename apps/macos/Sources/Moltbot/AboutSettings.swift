...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/openx/openx") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/openx/openx")
            ...
            if let updater {
                ...
                if updater.isAvailable {
                    VStack(spacing: 10) {
                        ...
                        Button("Check for Updatesâ€?) { updater.checkForUpdates(nil) }
                    }
                } else {
        ...
        .onAppear {
            ...
            // Keep Sparkleâ€™s auto-check setting in sync with the persisted toggle.
    ...
    private var buildTimestamp: String? {
        guard let raw = Bundle.main.object(forInfoDictionaryKey: "openxBuildTimestamp") as? String
        else { return nil }
    ...
    private var gitCommit: String {
        Bundle.main.object(forInfoDictionaryKey: "openxGitCommit") as? String ?? "unknown"
    }
