...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "bot.openx", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return openxConfigFile.defaultWorkspaceURL() }
