...
enum openxConfigFile {
    private static let logger = Logger(subsystem: "bot.openx", category: "config")

    static func url() -> URL {
        openxPaths.configURL
    }

    static func stateDirURL() -> URL {
        openxPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        openxPaths.workspaceURL
    }
