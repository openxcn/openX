...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "bot.openx", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        openxPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        openxPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
