...
enum UIStrings {
    static let welcomeTitle = "Welcome to openx"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: openxOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: openxChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g openx@\(version)"
    }
