...
private let onboardingWizardLogger = Logger(subsystem: "bot.openx", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between openxProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = openxProtocol.AnyCodable
