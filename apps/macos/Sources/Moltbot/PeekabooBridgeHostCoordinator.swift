...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "bot.openx", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: openxPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = openxPeekabooBridgeServices()
...
@MainActor
private final class openxPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "bot.openx.peekaboo")
