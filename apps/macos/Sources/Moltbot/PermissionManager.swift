...
enum AppleScriptPermission {
    private static let logger = Logger(subsystem: "bot.openx", category: "AppleScriptPermission")
    ...
    /// Triggers the TCC prompt and opens System Settings â†?Privacy & Security â†?Automation.
    @MainActor
