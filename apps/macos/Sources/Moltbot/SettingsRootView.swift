...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .openxSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? openxPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? openxPaths.stateDirURL.path
...
extension Notification.Name {
    static let openxSelectSettingsTab = Notification.Name("openxSelectSettingsTab")
}
