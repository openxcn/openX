...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "bot.openx", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "bot.openx", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [openxChatMessage] = messages.compactMap { item in
