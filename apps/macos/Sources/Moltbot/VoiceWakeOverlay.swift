...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "bot.openx", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other openx windows, but below the system’s pop-up menus.
