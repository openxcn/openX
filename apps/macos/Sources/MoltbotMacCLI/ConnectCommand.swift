...
struct ConnectOptions {
    ...
    var clientId: String = "openx-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: openx-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "openx macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("openx macOS Gateway Connect")
