import Testing
@testable import openxDiscovery
...
struct WideAreaGatewayDiscoveryTests {
    @Test func discoversBeaconFromTailnetDnsSdFallback() {
            ...
            dig: { args, _ in
                ...
                if recordType == "PTR" {
                    if nameserver == "@100.123.224.76" {
                        return "steipetacstudio-gateway._openx-gw._tcp.clawdbot.internal.\n"
                    }
                    return ""
                }
                if recordType == "SRV" {
                ...
                if recordType == "TXT" {
                    return "\"displayName=Peter\\226\\128\\153s Mac Studio (openx)\" \"gatewayPort=18789\" \"tailnetDns=peters-mac-studio-1.sheep-coho.ts.net\" \"cliPath=/Users/steipete/openx/src/entry.ts\""
                }
                return ""
            })
        ...
        let expectedDisplay = "Peter\u{2019}s Mac Studio (openx)"
        ...
        #expect(beacon.cliPath == "/Users/steipete/openx/src/entry.ts")
    }
}
