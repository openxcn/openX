...
public typealias openxPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias openxPlatformImage = UIImage
#endif

public struct openxChatUsageCost: Codable, Hashable, Sendable {
...
public struct openxChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: openxChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(openxChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct openxChatMessageContent: Codable, Hashable, Sendable {
...
public struct openxChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [openxChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: openxChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [openxChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: openxChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(openxChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([openxChatMessageContent].self, forKey: .content) {
...
public struct openxChatHistoryPayload: Codable, Sendable {
...
public struct openxSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct openxSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [openxSessionPreviewItem]
}

public struct openxSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [openxSessionPreviewEntry]

    public init(ts: Int, previews: [openxSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct openxChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct openxChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct openxAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct openxChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct openxGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct openxPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: openxPlatformImage?
...
public struct openxChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
