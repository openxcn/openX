...
@MainActor
public struct openxChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    private var visibleMessages: [openxChatMessage] {
        let base: [openxChatMessage]
    ...
    private var emptyStateMessage: String {
        #if os(macOS)
        "Type a message below to start.\nReturn sends â€?Shift-Return adds a line break."
        #else
        "Type a message below to start."
        #endif
    }
    ...
    private func mergeToolResults(in messages: [openxChatMessage]) -> [openxChatMessage] {
    ...
    private func isToolResultMessage(_ message: openxChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: openxChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: openxChatMessage) -> String {
