...
public enum openxCanvasA2UICommand: String, Codable, Sendable {
...
public struct openxCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct openxCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
