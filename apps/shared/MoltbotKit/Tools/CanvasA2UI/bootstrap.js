...
import "@a2ui/lit/ui";
import { themeContext } from "@openx/a2ui-theme-context";
...
class openxA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = css`
    :host {
      ...
      padding:
        var(--openx-a2ui-inset-top, 0px)
        var(--openx-a2ui-inset-right, 0px)
        var(--openx-a2ui-inset-bottom, 0px)
        var(--openx-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--openx-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--openx-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--openx-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--openx-a2ui-empty-top, var(--openx-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    globalThis.openxA2UI = api;
    globalThis.clawdbotA2UI = api;
    this.addEventListener("a2uiaction", (evt) => this.#handleA2UIAction(evt));
    this.#statusListener = (evt) => this.#handleActionStatus(evt);
    globalThis.addEventListener("openx:a2ui-action-status", this.#statusListener);
    this.#syncSurfaces();
  }
  ...
  disconnectedCallback() {
    ...
    if (this.#statusListener) {
      globalThis.removeEventListener("openx:a2ui-action-status", this.#statusListener);
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis.__openxLastA2UIAction = userAction;

    const handler =
      globalThis.webkit?.messageHandlers?.openxCanvasA2UIAction ??
      globalThis.webkit?.messageHandlers?.clawdbotCanvasA2UIAction ??
      globalThis.openxCanvasA2UIAction ??
    ...
    if (handler?.postMessage) {
      try {
        ...
        if (
          handler === globalThis.openxCanvasA2UIAction ||
...
customElements.define("openx-a2ui-host", openxA2UIHost);
