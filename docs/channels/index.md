---
summary: "Messaging platforms openx can connect to"
read_when:
  - You want to choose a chat channel for openx
  - You need a quick overview of supported messaging platforms
---
# Chat Channels

openx can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and openx will route per chat.
