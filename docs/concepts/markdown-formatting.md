...
openx formats outbound Markdown by converting it into a shared intermediate
...
```markdown
Hello **world** â€?see [docs](https://docs.openx.bot).
```
...
```json
{
  ...
  "links": [
    { "start": 19, "end": 23, "href": "https://docs.openx.bot" }
  ]
}
```
