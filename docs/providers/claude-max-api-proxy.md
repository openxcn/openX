...
You can point openx at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or openx
...
- [Anthropic provider](/providers/anthropic) - Native openx integration with Claude setup-token or API keys
