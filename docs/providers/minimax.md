---
summary: "Use MiniMax M2.1 in openx"
read_when:
  - You want MiniMax models in openx
...
Configure manually via `openx.json`:
...
- Use `openx models list` and `openx models set minimax/MiniMax-M2.1` to switch.
...
- Running `openx configure` and selecting **MiniMax M2.1**, or
