---
summary: "Use Qwen OAuth (free tier) in openx"
read_when:
  - You want to use Qwen with openx
...
```bash
openx models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, openx will sync credentials
