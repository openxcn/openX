...
Deploy openx on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/openx-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/openx` â€?Control UI
...
This exports your openx state + workspace so you can migrate to another host without losing config or memory.
