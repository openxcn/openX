...
function setBlueBubblesDmPolicy(cfg: openxConfig, dmPolicy: DmPolicy): openxConfig {
  const allowFrom =
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "1. Open BlueBubbles Server â†?Settings â†?Webhooks",
        "2. Add your openx gateway URL + webhook path",
