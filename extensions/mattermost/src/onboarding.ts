import type { ChannelOnboardingAdapter, openxConfig, WizardPrompter } from "clawdbot/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.openx.bot/channels/mattermost",
    ].join("\n"),
