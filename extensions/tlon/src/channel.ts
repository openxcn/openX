...
const tlonOutbound: ChannelOutboundAdapter = {
  ...
  sendText: async ({ cfg, to, text, accountId, replyToId, threadId }) => {
    const account = resolveTlonAccount(cfg as openxConfig, accountId ?? undefined);
...
export const tlonPlugin: ChannelPlugin = {
  ...
  config: {
    listAccountIds: (cfg) => listTlonAccountIds(cfg as openxConfig),
    resolveAccount: (cfg, accountId) => resolveTlonAccount(cfg as openxConfig, accountId ?? undefined),
  ...
  setup: {
    ...
    validateInput: ({ cfg, accountId, input }) => {
      ...
      const resolved = resolveTlonAccount(cfg as openxConfig, accountId ?? undefined);
