...
# Output:
# - dist/openx.app
# - dist/openx-<version>.zip
# - dist/openx-<version>.dmg
...
ZIP="$ROOT_DIR/dist/openx-$VERSION.zip"
DMG="$ROOT_DIR/dist/openx-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/openx-$VERSION.notary.zip"
