...
SMOKE_IMAGE="${CLAWDBOT_INSTALL_SMOKE_IMAGE:-openx-install-smoke:local}"
NONROOT_IMAGE="${CLAWDBOT_INSTALL_NONROOT_IMAGE:-openx-install-nonroot:local}"
INSTALL_URL="${CLAWDBOT_INSTALL_URL:-https://openx.bot/install.sh}"
CLI_INSTALL_URL="${CLAWDBOT_INSTALL_CLI_URL:-https://openx.bot/install-cli.sh}"
