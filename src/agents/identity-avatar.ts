...
function resolveAvatarSource(cfg: openxConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: openxConfig, agentId: string): AgentAvatarResolution {
