...
describe("createopenxCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createopenxCodingTools({
      config,
    ...
    const anthropicTools = createopenxCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createopenxCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createopenxCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
