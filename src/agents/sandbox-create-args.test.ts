  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "openx.sandbox=1",
        "--label",
        "openx.sessionKey=main",
        "--label",
        "openx.createdAtMs=1700000000000",
        "--label",
        "openx.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
