...
export const DEFAULT_SANDBOX_IMAGE = "openx-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openx-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openx-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openx-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openx-sbx-browser-";
