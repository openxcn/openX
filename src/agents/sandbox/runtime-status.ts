...
function resolveMainSessionKeyForSandbox(params: { cfg?: openxConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: openxConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`openx sandbox explain --session ${runtime.sessionKey}`)}`,
  );
