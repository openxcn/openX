...
import type { openxConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: openxConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: openxConfig | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "openx-bundled";
}

export function resolveBundledAllowlist(config?: openxConfig): string[] | undefined {
