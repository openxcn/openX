...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openx", { botUsername: "openx" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openx args", {
        botUsername: "openx",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openx" })).toBe(
      "/help@otherbot",
    );
  });
