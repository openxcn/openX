import type { openxConfig } from "../config/types.js";
...
export function isCommandEnabled(cfg: openxConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: openxConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: openxConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: openxConfig) {
