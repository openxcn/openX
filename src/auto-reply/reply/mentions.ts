...
function resolveMentionPatterns(cfg: openxConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: openxConfig | undefined, agentId?: string): RegExp[] {
