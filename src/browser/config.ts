import type { BrowserConfig, BrowserProfileConfig, openxConfig } from "../config/config.js";
import {
 ...
 *
 * Note: this is a openx browser profile (routing config), not a Chrome user profile.
