...
export const A2UI_PATH = "/__openx__/a2ui";
export const CANVAS_HOST_PATH = "/__openx__/canvas";
export const CANVAS_WS_PATH = "/__openx/ws";
...
(() => {
  ...
  const handlerNames = ["openxCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.openx = globalThis.openx ?? {};
  globalThis.openx.postMessage = postToNode;
  globalThis.openx.sendUserAction = sendUserAction;
  globalThis.openxPostMessage = postToNode;
  globalThis.openxSendUserAction = sendUserAction;
