...
export function listChannelMessageActions(cfg: openxConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: openxConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: openxConfig): boolean {
  for (const plugin of listChannelPlugins()) {
