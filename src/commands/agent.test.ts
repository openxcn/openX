...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "openx-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<openxConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<openxConfig["telegram"]>>,
