...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/openx when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "openx");
  ...
  it("flags ~/openx when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "openx");
