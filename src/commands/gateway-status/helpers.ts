...
import type { openxConfig, ConfigFileSnapshot } from "../../config/types.js";
...
export function resolveTargets(cfg: openxConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
export function buildNetworkHints(cfg: openxConfig) {
