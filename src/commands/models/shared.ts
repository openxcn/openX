...
export async function updateConfig(
  mutator: (cfg: openxConfig) => openxConfig,
): Promise<openxConfig> {
...
export function resolveModelTarget(params: { raw: string; cfg: openxConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: openxConfig): Set<string> {
