...
export function applyZaiConfig(cfg: openxConfig): openxConfig {
...
export function applyOpenrouterProviderConfig(cfg: openxConfig): openxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: openxConfig): openxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: openxConfig): openxConfig {
...
export function applyOpenrouterConfig(cfg: openxConfig): openxConfig {
...
export function applyMoonshotProviderConfig(cfg: openxConfig): openxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: openxConfig): openxConfig {
...
export function applyKimiCodeProviderConfig(cfg: openxConfig): openxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: openxConfig): openxConfig {
...
export function applySyntheticProviderConfig(cfg: openxConfig): openxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: openxConfig): openxConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: openxConfig): openxConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: openxConfig): openxConfig {
