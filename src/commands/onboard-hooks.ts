...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.openx.bot/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("openx hooks list")}`,
      `  ${formatCliCommand("openx hooks enable <name>")}`,
      `  ${formatCliCommand("openx hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
