...
function resolveAnthropicDefaultAuthMode(cfg: openxConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: openxConfig): openxConfig {
...
export function applyTalkApiKey(config: openxConfig): openxConfig {
...
export function applyModelDefaults(cfg: openxConfig): openxConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: openxConfig): openxConfig {
...
export function applyLoggingDefaults(cfg: openxConfig): openxConfig {
...
export function applyContextPruningDefaults(cfg: openxConfig): openxConfig {
...
export function applyCompactionDefaults(cfg: openxConfig): openxConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
