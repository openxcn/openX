...
export function parseopenxVersion(raw: string | null | undefined): openxVersion | null {
  if (!raw) return null;
...
export function compareopenxVersions(
  a: string | null | undefined,
  b: string | null | undefined,
): number | null {
  const parsedA = parseopenxVersion(a);
  const parsedB = parseopenxVersion(b);
