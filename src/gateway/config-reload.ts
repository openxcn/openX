...
import type { openxConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: openxConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: openxConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: openxConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: openxConfig) => void;
  log: {
