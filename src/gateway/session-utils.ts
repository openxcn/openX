...
import { type openxConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: openxConfig): string[] {
...
export function listAgentsForGateway(cfg: openxConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: openxConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: openxConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: openxConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: openxConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: openxConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: openxConfig): GatewaySessionsDefaults {
