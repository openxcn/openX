...
const saveSessionToMemory: HookHandler = async (event) => {
  ...
  try {
    ...
    const cfg = context.cfg as openxConfig | undefined;
    ...
    if (sessionFile) {
      ...
      if (sessionContent && cfg) {
        ...
        const openxRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../..");
        const slugGenPath = path.join(openxRoot, "llm-slug-generator.js");
