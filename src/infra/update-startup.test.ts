...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "openx-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveopenxPackageRoot } = await import("./openx-root.js");
    ...
    vi.mocked(resolveopenxPackageRoot).mockResolvedValue("/opt/openx");
