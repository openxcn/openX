...
export const DEFAULT_LOG_DIR = "/tmp/openx";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "openx.log"); // legacy single-file path

const LOG_PREFIX = "openx";
...
function resolveSettings(): ResolvedSettings {
  let cfg: openxConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => openxConfig;
      };
