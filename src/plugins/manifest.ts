...
export const PLUGIN_MANIFEST_FILENAME = "openx.plugin.json";
...
// package.json "openx" metadata (used for onboarding/catalog)
...
export type openxPackageManifest = {
  extensions?: string[];
...
): openxPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.openx ?? manifest[LEGACY_MANIFEST_KEY];
}
