...
export function listBindings(cfg: openxConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: openxConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: openxConfig) {
