...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof openxConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: openxConfig; env: NodeJS.ProcessEnv }): {
  cfg: openxConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
