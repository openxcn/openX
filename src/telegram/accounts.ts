...
export function listTelegramAccountIds(cfg: openxConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: openxConfig): string {
...
function mergeTelegramAccountConfig(cfg: openxConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: openxConfig): ResolvedTelegramAccount[] {
