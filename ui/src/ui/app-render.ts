        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src="https://mintcdn.com/clawdhub/4rYvG-uuZrMK_URE/assets/pixel-lobster.svg?fit=max&auto=format&n=4rYvG-uuZrMK_URE&q=85&s=da2032e9eac3b5d9bfe7eb96ca6a8a26" alt="openx" />
            </div>
            <div class="brand-text">
              <div class="brand-title">openx</div>
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${state.tab === "nodes"
          ? renderNodes({
              ...
              onExecApprovalsSelectAgent: (agentId: string | null) => {
                state.execApprovalsSelectedAgent = agentId;
              },
              onExecApprovalsPatch: (path: (string | number)[], value: unknown) =>
        ...
        ${state.tab === "config"
          ? renderConfig({
              ...
              onFormPatch: (path: Array<string | number>, value: unknown) => updateConfigFormValue(state, path, value),
              onSearchChange: (query: string) => (state.configSearchQuery = query),
              onSectionChange: (section: string | null) => {
                state.configActiveSection = section;
                state.configActiveSubsection = null;
              },
              onSubsectionChange: (section: string | null) => (state.configActiveSubsection = section),
